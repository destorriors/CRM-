...
<!-- - ОСТАВИЛ НА ПОТОМ -->
<!-- - Необходимо подогнать условия под то, что клиент может быть добавлен с улицы и тогда он отмечается не как у актуальных(надо переименовать в постоянных ) спецов, а как у тех у кого когда-то был -->
<!-- - Постоянные - это, где дата false, временные это, где нет даты false -->
